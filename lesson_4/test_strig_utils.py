...
# Возвращает `True`, если строка содержит искомый символ и `False` - если нет(позитивные проверки)
@pytest.mark.positive
...
# Возвращает `True`, если строка содержит искомый символ и `False` - если нет(негативные проверки)
@pytest.mark.negative
@pytest.mark.parametrize("input_str, symbol_str, expected", [
...
# пробел + пробел
    (" ", " ", True),
# набор заглавных датинских букв + набор схожих по написанию букв кириллицей
    ("ABC", "АВС", False),
