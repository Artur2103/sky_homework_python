...
# тест изменения проекта(замена названия на 'python2')
def test_edit_project(get_company_id):
    ...
    resp = requests.put(f"{DataAuth.base_url}/projects/{project_id}",
                        json=edit_data, headers=my_headers)
